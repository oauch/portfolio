            ...
            <Flex align="start" gap={30}>
              ...
              <Flex isRow={false} align="start" gap={20}>
                ...
                <Text fs={1.6} lineH={40}>
                  ...
                  적이 있습니다.
                  <br />
                  그래서 useState를 통해 각 API 호출이나 응답에 setter로 값을
                  주고
                  <br />
                  <Accent>
                ...
                <Text fs={1.6} lineH={40}>
                  ...
                  <br />
                  동기 유발하고, 문제점 / 오류들에 대해서 실시간으로 피드백을
                  받을 수 있었습니다.
                </Text>
              </Flex>
            </Flex>
            ...
            <Flex align="start" gap={30}>
              ...
              <Flex isRow={false} align="start" gap={20}>
                ...
                <Text fs={1.6} lineH={40}>
                  ...
                  <br />
                  코드 리뷰를 통해 내가 발견하지 못한 부분은 팀원들의 도움을
                  받을 수 <br />
                  있다는 것을 알게 되었습니다.
                </Text>
                <Text fs={1.6} lineH={40}>
                  ...
                  동료에게 설명해주면서 동료도 지식을 얻어가지만, 본인도 공부를
                  한 번 더 하게 된다고 느꼈습니다. <br />
